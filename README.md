...
| `AppConfig` | SharePoint lista | Konfiguracija aplikacije | Delimično potvrđeno |
...
1. Dodati dokumentaciju za `AppConfig`.
2. Dodati dokumentaciju za `RezervisaniBrojevi`.
3. Dodati dokumentaciju za `Shared Documents`.
4. Dodati dokumentaciju za `EmailDocuments`.
5. Dodati dokumentaciju za `Exports`.
6. Analizirati Power Platform solution ZIP kada bude dostupan.
7. Ekstraktovati Power Apps Canvas app strukturu.
8. Ekstraktovati sve Power Automate flow definicije.
9. Dokumentovati sve connection references.
10. Dokumentovati environment variables.
11. Dokumentovati security/permission model.
